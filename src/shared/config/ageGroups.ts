...
export const AGE_GROUPS: AgeGroupConfig[] = [
  {
    ...
    emoji: '🌱',
    color: '#66BB6A',
    description: 'Vogais, reconhecimento visual, associação som-imagem',
    wordDifficulties: [1],
    availableGames: ['vowelgame', 'quiz', 'memory', 'firstletter'],
  ...
  },
  {
    ...
    emoji: '🌿',
    color: '#42A5F5',
    description: 'Família silábica, sílabas, decodificação, escrita guiada',
    wordDifficulties: [1, 2],
    availableGames: ['vowelgame', 'silfamilia', 'silfill', 'syllable', 'quiz', 'fill', 'memory', 'write', 'firstletter', 'buildsentence'],
  ...
  },
  {
    ...
    emoji: '🌳',
    color: '#FFA726',
    description: 'Fluência silábica, trissílabas, escrita autônoma, frases',
    wordDifficulties: [1, 2, 3],
    availableGames: ['silfamilia', 'silfill', 'syllable', 'quiz', 'fill', 'memory', 'write', 'firstletter', 'buildsentence', 'story'],
    defaultDifficulty: 'medium',
  ...
  },
  {
    ...
    emoji: '🌟',
    color: '#AB47BC',
    description: 'Velocidade, precisão, ditado, compreensão textual avançada',
    wordDifficulties: [1, 2, 3],
    availableGames: ['ditado', 'syllable', 'quiz', 'fill', 'memory', 'write', 'firstletter', 'buildsentence', 'story'],
