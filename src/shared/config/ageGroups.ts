...
export const AGE_GROUPS: AgeGroupConfig[] = [
  ...
  },
  {
    ...
    availableGames: ['vowelgame', 'silfamilia', 'syllable', 'quiz', 'fill', 'memory', 'write', 'firstletter', 'buildsentence'],
  ...
  },
  {
    ...
    wordDifficulties: [1, 2, 3],
    availableGames: ['silfamilia', 'syllable', 'quiz', 'fill', 'memory', 'write', 'firstletter', 'buildsentence', 'story'],
    defaultDifficulty: 'medium',
