...
import { Route, Pencil, Trash2, Check, FileText, ArrowLeft, Save, ArrowUp, ArrowDown } from 'lucide-react';
    ...
    <div style={{ padding: 16 }}>
            ...
            <div key={trail.id} style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', gap: 6, marginTop: 5, flexWrap: 'wrap' }}>
                  ...
                  {trail.published ? <><Check size={12} style={{ display: 'inline', verticalAlign: 'middle' }} /> Publicada</> : <><FileText size={12} style={{ display: 'inline', verticalAlign: 'middle' }} /> Rascunho</>}
                  </span>
                </div>
              </div>
      ...
      {filtered.length === 0 && (
        <div style={{ textAlign: 'center', padding: 48, color: 'var(--color-text-3)' }}>
          <div style={{ fontSize: 48, marginBottom: 8 }}><Route size={48} color="var(--color-text-3)" /></div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: 14, color: 'var(--color-text)' }}>
            {published ? <><Check size={14} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 4 }} />Publicada</> : <><FileText size={14} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 4 }} />Rascunho</>}
          </div>
                ...
                <div key={`${act.id}-${idx}`} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 11, color: 'var(--color-text-2)' }}>
                      <LucideIcon name={gameInfo.icon} size={11} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 3 }} />{gameInfo.label}
                    </div>
                  </div>
              ...
              return (
                <div key={act.id} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 11, color: 'var(--color-text-2)' }}>
                      <LucideIcon name={gameInfo.icon} size={11} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 3 }} />{gameInfo.label} · N{act.difficulty}
                    </div>
                  </div>
                  {count > 0 && (
                    <span style={{
