...
import { Check, Link, ArrowRight, Keyboard } from 'lucide-react';
        ...
        {games.map((g, i) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              >
                {g.mode === 'connect' ? <><Link size={12} className="inline" /> Ligar</> : <><Keyboard size={12} className="inline" /> Digitar</>}
              </div>
            </div>
    ...
    >
      ...
      >
          ...
          {pairs.map(pair => {
            ...
            return (
              ...
              >
                ...
                {isMatched && <span className="text-xs absolute top-1.5 right-2"><Check size={14} color="var(--color-success)" /></span>}
              </button>
            );
          })}
        </div>
        ...
        <div className="flex items-start justify-center pointer-events-none pt-8" style={{ width: '20%' }}>
          <span className="text-lg" style={{ opacity: selectedLeft ? 0.7 : 0.15 }}><Link size={18} /></span>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-center pointer-events-none" style={{ width: '20%' }}>
                <span className="text-base opacity-30"><ArrowRight size={16} /></span>
              </div>
        ...
        {game.pairs.map((pair, i) => {
          ...
          return (
            ...
            >
              ...
              {st === 'correct' && <span className="text-base"><Check size={16} color="var(--color-success)" /></span>}
            </button>
          );
        })}
      </div>
